¿Te diste cuenta? Estamos usando bolitas para representar la hora de un reloj. Al programar, usamos las _abstracciones_ que tenemos para _modelar_ cosas del mundo real.
